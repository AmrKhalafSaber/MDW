...
#import "MyAgendaSecondDayView.h"
...
@interface MyAgendaSecondDayView ()

@end

@implementation MyAgendaSecondDayView
...
-(void)getalldaysbeansmethod:(AllDays *)alldays
{
    ...
    Agenda *firstday=[alldaysarray objectAtIndex:2];
