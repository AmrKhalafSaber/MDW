...
@interface AllDaysView ()

@end

@implementation AllDaysView
{
     NSString *status;
...
- (void)viewDidLoad {
    ...
    [_alldays setDelegate:self];
    [_alldays setDataSource:self];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AllDaysViewCell" forIndexPath:indexPath];
